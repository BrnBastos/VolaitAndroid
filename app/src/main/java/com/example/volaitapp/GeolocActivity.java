...
public class GeolocActivity extends AppCompatActivity implements BuscarEndereco.OnTaskCompleted, SensorEventListener {
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (mTrackingLocation) {
                    new BuscarEndereco(GeolocActivity.this, GeolocActivity.this)
